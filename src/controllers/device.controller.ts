...
export const assignDeviceToUser = async (req: Request, res: Response): Promise<Response> => {
...
export const markDeviceAsLost = async (req: Request, res: Response): Promise<Response> => {
...
export const removeDeviceFromUser = async (req: Request, res: Response): Promise<Response> => {
